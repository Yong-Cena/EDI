...
public class ArraySet<T> implements SetADT<T>, Iterable<T> {
    ...
    */
    ...
    public SetADT<T> unionRv(SetADT<T> oSet) {
        ...
        SetADT<T> unionSet = new ArraySet();
    ...
    //Método privado que hace efectivamente la unión RECURSIVA.
    private void unionRv(Iterator<T> iterth, Iterator<T> iteros, SetADT<T> unse) {
