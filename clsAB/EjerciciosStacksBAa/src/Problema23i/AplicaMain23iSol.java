            ...
            if( e1 instanceof Double || e1 instanceof Boolean ||
                ...
                while( !paux1.isEmpty() ) {
                    ...
                    switch( clasestr ) {
                        ...
                        case "String":
                            String s1, s2, s12;
                            s1= (String) e1;    s2= (String) e2;
                            s12= s1 + s2;
                            e12= (T) s12;
                            break;
                        case "Complejo":
                            Complejo c1, c2, c12;    Double pr, pi;
                            c1= (Complejo) e1;    c2= (Complejo) e2;
                            pr= c1.getParteReal() + c2.getParteReal();
                            pi= c1.getParteImaginaria() + c2.getParteImaginaria();
                            c12= new Complejo(pr, pi);
                            e12= (T) c12;
                            break;
                        // No hay default.    
                    }
