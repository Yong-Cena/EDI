...
public class AplicaMain45 {
    ...
    public static void main(String[] args) {
        ...
        es2.add( "trece", es2.size()+1 );
        System.out.println(" es2: " + es2.toString());
        
        System.out.println("1- es1.mix2lseN(es2) ");
        es1.mix2lseN(es2);
        System.out.println("1- Comprobando es1: " + es1.toString());
        System.out.println("1- Comprobando es2: " + es2.toString());
        

        System.out.println("2- es2.mix2lseN(es1) ");
        es2.add( "veintiuno", es2.size()+1 );
        es2.add( "veintidos", es2.size()+1 );
        System.out.println(" es2: " + es2.toString());
        System.out.println(" es1: " + es1.toString());        
        //es2.mix2lseN(es1);
        System.out.println("2-Comprobando es2: " + es2.toString());
        System.out.println("2-Comprobando es1: " + es1.toString());
